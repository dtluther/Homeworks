...
describe Dessert do
  ...
  describe "#eat" do
    it "subtracts an amount from the quantity" do
      expect(brownie.quantity).to eq(10)
      brownie.eat(5)
      expect(brownie.quantity).not_to eq(10)
    end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return('The Legendary Chef John')
      expect(brownie.serve).to eq('The Legendary Chef John has made 10 brownies!')
    end
  end
